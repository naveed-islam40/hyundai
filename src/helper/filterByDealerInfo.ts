...
export const filterByDealerInfo = (
  ...
  const [_, { vehicles }] = matchingEntry;
...
export const getDefaultColor = (year: string, model: string) => {
  ...
  const paintMaterialMap = {
    "2015-2016": {
      "Elantra (UD)": "Ice/Quartz White Pearl Tricoat",
    },
    "2017-2018": {
      "Elantra (ADA)": "Ice/Quartz White Pearl Tricoat",
      "Santa Fe Sport (AN)": "Frost White Pearl",
    },
    "2015-2019": {
      "Sonata (LFA)": "Ice/Quartz White Pearl Tricoat",
    },
    "2019": {
      "Santa Fe (TMA)": "Ice/Quartz White Pearl Tricoat",
    },
    "2017-2021": {
      "Tucson (TL)": "Dazzling White",
    },
    "2021-2023": {
      "Santa Fe Hybrid (TM HEV)": "Ceramic White",
    },
    "2020-2023": {
      "Palisade (LX2)": "Galactic Gray",
    },
  };
