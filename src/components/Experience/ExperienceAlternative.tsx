      ...
      <div className="w-full max-w-3xl p-6 text-white text-center relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-20">
          <div className="w-full md:w-1/2 flex flex-col items-start">
            <Button
              className="bg-[#E51C22] hover:bg-[#E51C22] hover:text-white text-white px-6 py-2 h-auto w-full mb-4 uppercase flex flex-col text-base font-bold cursor-pointer"
              onClick={() =>
