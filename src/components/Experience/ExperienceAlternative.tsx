        ...
        <div className="flex flex-col md:flex-row justify-between gap-40">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-start">
            <button
              ...
              onClick={() =>
                handleNavigate(
                  "/cutomer-details?page=1&skip=schedule",
                  " Customer Drop-Off"
                )
              }
            >
          ...
          <div className="w-full md:w-1/3 flex flex-col items-start">
            <button
              // variant="outline"
              className="bg-[#E51C22] hover:bg-[#E51C22] hover:text-white text-white  py-2 h-auto w-full mb-4 uppercase flex flex-col text-base font-bold cursor-pointer rounded-xs"
              onClick={() => handleNavigate("/", "Paint Repairs")}
            >
              <span className="capitalize text-xs">for</span>
              Paint Repairs
            </button>
            <ul className="space-y-2 w-full text-left">
              ...
              <li className="flex items-start gap-2">
                ...
                />
                <span>
                  e.g. e.g. Information for Paint Repairs that is Coming Soon to
                  this screen
                </span>
              </li>
              <li className="flex items-start gap-2">
