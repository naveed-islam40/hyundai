...
const Footer = () => {
  return (
    <footer className="max-w-8xl max-sm:py-4 mx-auto flex justify-between items-center md:px-10 px-5  bg-[#FFFFFF] py-2 md:py-5 text-center border-t border-gray-200 font-sans relative z-10">
